<?php
/**
 * 	A class for hooking into Big Cartel's API and retrieving full product 
 *	information. You can select all products, a single product or products
 * 	from one or many categories. 
 * 
 * 	@package BigCartel
 * 	@author Gareth Poole
 * 	@copyright Gareth Poole 2011
 * 	@version 1.0
 */
class BigCartel {
		
	const API_URL_PREFIX 	= 'http://api.bigcartel.com/';
	const API_URL_STORE		= 'store';
